export const Dorpdown = ({ expandedCategory, categoryName }) => {
  return (
    <svg
...
export const Remove = ({ expandedCategory, categoryName }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-5 w-5"
...
export const Icon = ({ expandedCategory, categoryName }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-5 w-5"
...
export const Edit = ({ expandedCategory, categoryName }) => {
 return (
   <svg
     width="20"
     height="20"
...
export const Valid = () => {
  return (
    <svg
      className="w-4 h-4 mr-2 text-[#ffffff]"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
...
export const Contact = () => {
  return (
    <svg
      className="w-5 h-5 text-blue-600 mr-2 mt-2"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
...
export const Title = () => {
  return (
    <svg
      className="w-5 h-5 text-[#000000] mr-2 mt-2"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
...
export const SendDraftLogo = () => {
  return (
    <svg
      className="animate-spin h-5 w-5 mr-3 inline text-yellow-500"
      viewBox="0 0 24 24"
    >
      <circle
        className="opacity-25"
...
export const LoginIcon = () => {
  return (
    <svg
      className="w-6 h-6 text-[#D4AC34] mt-0.5 mr-2"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
